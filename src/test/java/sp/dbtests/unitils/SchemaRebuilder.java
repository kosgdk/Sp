...
public class SchemaRebuilder {
    ...
    public static void setConstraintType(ConstraintsDisabler.ConstraintType constraintType) {
        SchemaRebuilder.constraintType = constraintType;
    }

    public static ConstraintsDisabler.ConstraintType getConstraintType() {
